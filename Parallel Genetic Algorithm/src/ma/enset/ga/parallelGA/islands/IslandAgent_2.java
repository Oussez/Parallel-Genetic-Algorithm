...
public class IslandAgent_2 extends Agent {
        ...
        sequentialBehaviour.addSubBehaviour(new Behaviour() {
            ...
            public void action() {
                ...
                if (receivedMSG!=null){
                    ...
                    System.out.println(">ISLAND 2> ("+cpt+") Agent ["+sender.getLocalName()+"] ---> Fitness:  "+fintess);
            ...
            public boolean done() {
                if(iteration == 10*GAUtils.POPULATION_SIZE|| agentsFitness.get(0).getFitness() == GAUtils.MAX_FITNESS){
                    ...
                    if(iteration == 10*GAUtils.POPULATION_SIZE)
                        response= ">>> ISLAND 2 : NO OPTIMUM INDIVIDUAL FOUND ***";
                    else{
                        response=">>> ISLAND 2 [iteration : "+iteration+"] THE BEST OPTIMUM FOUND  : "+Arrays.toString(getBestIndividual())+" --> fitness : "+agentsFitness.get(0).getFitness();
                    }
                    ACLMessage aclMessage = new ACLMessage(ACLMessage.REQUEST);
